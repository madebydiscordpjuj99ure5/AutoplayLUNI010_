-- ============================================================
-- LUNI010_ DUELS - BLUE EDITION + FAST ESP
...
local DISCORD_TEXT = "discord.gg/pjuj99ure5"
...
local function enableGalaxySkyBright()
    ...
    galaxySkyBrightConn = RunService.Heartbeat:Connect(function()
        ...
        local t = tick() * 0.5
        Lighting.Ambient = Color3.fromRGB(120 + math.sin(t) * 60, 50 + math.sin(t * 0.😎 * 40, 180 + math.sin(t * 1.2) * 50)
        if galaxyBloom then
...
RadiusInput.BackgroundColor3 = Color3.fromRGB(5, 5, 😎
...
pTrack.BackgroundColor3 = Color3.fromRGB(5, 5, 😎
pTrack.ZIndex = 2
...
for i = 1, 60 do
    ...
    task.spawn(function()
        ...
        while ball.Parent do
            ...
            local newY = startY + math.cos(t * speedMult * 0.😎 * 0.015
...
titleLabel.Text = "LUNI010_ DUELS"
...
subtitleLabel.Text = "discord.gg/pjuj99ure5"
